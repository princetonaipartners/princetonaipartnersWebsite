...
<BarChartComparison
  title="Invoice Processing: Before vs After Automation"
  data={[
    { metric: "Monthly Hours", before: 86, after: 8 },
    { metric: "Error Rate (%)", before: 3, after: 0.1 },
    { metric: "Monthly Cost ($)", before: 2150, after: 400 }
  ]}
