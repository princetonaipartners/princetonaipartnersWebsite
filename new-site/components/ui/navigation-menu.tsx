...
/**
 * NavigationMenu - Desktop navigation with dropdown menus
 * Built on Base UI NavigationMenu primitive with shadcn styling
 */
  ...
  return (
    <NavigationMenuPrimitive.Trigger
      ...
      className={cn(
        ...
        'group text-text-secondary dark:text-dark-text-secondary hover:text-brand-primary dark:hover:text-dark-brand-primary',
        className
      )}
      {...props}
    >
...
function NavigationMenuPopup({
  ...
  return (
    <NavigationMenuPrimitive.Popup
      className={cn(
        'data-[ending-style]:easing-[ease] relative h-[var(--popup-height)] origin-[var(--transform-origin)] rounded-xl bg-popover shadow-xl outline-1 outline-border transition-[opacity,transform,width,height,scale,translate] duration-[var(--duration)] ease-[var(--easing)] data-[ending-style]:scale-90 data-[ending-style]:opacity-0 data-[ending-style]:duration-150 data-[starting-style]:scale-90 data-[starting-style]:opacity-0 w-[var(--popup-width)] xs:w-[var(--popup-width)]',
        'dark:bg-dark-bg-secondary dark:shadow-none dark:outline-dark-border dark:-outline-offset-1',
        className
      )}
      {...props}
    >
...
function NavigationMenuLink({
  ...
  return (
    <NavigationMenuPrimitive.Link
      ...
      className={cn(
        "data-[active]:focus:bg-accent data-[active]:hover:bg-accent data-[active]:bg-accent/50 data-[active]:text-accent-foreground hover:bg-accent hover:text-accent-foreground focus:bg-accent focus:text-accent-foreground focus-visible:ring-ring/50 [&_svg:not([class*='text-'])]:text-muted-foreground flex flex-col gap-1 rounded-lg p-3 text-sm transition-all outline-none focus-visible:ring-[3px] focus-visible:outline-1 [&_svg:not([class*='size-'])]:size-4",
        className
      )}
      {...props}
    />
  ...
  return (
    <svg width="20" height="10" viewBox="0 0 20 10" fill="none" {...props}>
      <path
        ...
        className="fill-popover dark:fill-dark-bg-secondary"
      />
      <path
      ...
      <path
        ...
        className="dark:fill-dark-border"
      />
    </svg>
  );
}
